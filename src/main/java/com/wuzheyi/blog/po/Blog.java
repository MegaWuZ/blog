...
public class Blog {
    ...
    public Blog(Long id, String title, String content, String firstPicture, String flag, Integer views, Boolean appreciation, Boolean shareStatement, Boolean commentabled, Boolean published, Boolean recommend, Date createTime, Date updateTime, Long userId, Long typeId, String tagIds, String description, Type type, User user, List<Tag> tags, List<Comment> comments) {
        this.id = id;
        this.title = title;
